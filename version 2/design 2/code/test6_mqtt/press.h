...
void handleportstate()
{
   for (uint8_t x = 0; x <= 4; x++)
 {
   ...
   {
    if (last_press[x] == 3)      // last press was hold 
     {
...
void portsSTATE() // handles the state of ports      // add provision of checking ina_port varible - has the ina chip been idetified?
{
